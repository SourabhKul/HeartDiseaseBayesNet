...
class BayesNetCustom(object):
    ...
    def __init__(self):
        ...
        '''Custom BN based on 'expert' knowledge '''
        bn['A'] = []
        bn['G'] = []
        bn['CP'] = ['HD','A'] # Age is related with chest pain, as there can be various other reasons which cause chest pain in an aged person
        bn['BP'] = ['G']
        bn['CH'] = [] # Causal relation of age and gender toward cholesterol levels was removed, signifying that there is a genetic predisposition to higher cholesterol levels. A good parent here might be the presence of the genetic markers of high cholesterol in the patient's genome 
        bn['ECG'] = ['HD']
        bn['HR'] = ['HD', 'A'] # Removed blood pressure as a parent, as the increase in heart rate due to increased blood pressure usualy signifies a heart disease anyways
        bn['EIA'] = ['HD','A'] # Age is an important factor in wether exercise induces angia. If an aged patient has EIA, the age might parially 'explain it away' 
        bn['HD'] = ['CH', 'BP']
